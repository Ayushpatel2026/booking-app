...
const Booking = () => {
    ...
    const { data: paymentIntentData } = useQuery("createPaymentIntent", () => {
        return apiClient.createPaymentIntent(hotelId as string, numberOfNights.toString())
    ...
    // to make TypeScript happy cause hotel is possibly undefined, in reality this would never happen
    if (!hotel) {
        return <></>
    }
